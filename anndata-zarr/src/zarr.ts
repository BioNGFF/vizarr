import { FetchStore, Group, type Readable, open, get } from "zarrita"
import { z } from "zod"
...
export async function getData(root: Group<Readable>, path: string, slice?: (number | null)[]): Promise<{ data: unknown[], dtype: string }> {
